...
%弹出输入框，选择要识别的图片
select_person_num=str2double(cell2mat(inputdlg('第几位：')));%总共40个人
select_img_num=str2double(cell2mat(inputdlg('第几张：')));%总共10张图
%%
...
disp('显示选择的图片...')  
figure(2);
subplot(2,1,1);imshow(select_img);title('原图');
subplot(2,1,2);
